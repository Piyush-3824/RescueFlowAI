...
const HOW_IT_WORKS = [
  { step: "1", icon: Camera, title: "Report",     desc: "Worker reports an incident.",          sub: "Upload photo, video, voice note or text in seconds." },
  { step: "2", icon: Brain,  title: "AI Analyses", desc: "AI identifies hazard and severity.",   sub: "Gemini AI calculates risk score & OSHA recordability." },
  { step: "3", icon: Users,  title: "Respond",     desc: "The correct safety team is notified.", sub: "Instant dispatch of HazMat, Fire or First Aid units."  },
];
      ...
      <section id="how-it-works" className="py-20 border-t border-white/[0.06]">
        <div className="mx-auto max-w-6xl px-6">
          <div className="text-center mb-14">
            <p className="text-xs font-bold uppercase tracking-widest text-amber-400 mb-2">Simple Workflow</p>
            <h2 className="text-3xl font-extrabold text-white/90 sm:text-4xl">How RescueFlowAI Works</h2>
          </div>
      ...
      <footer className="border-t border-white/[0.06] py-10">
        <div className="mx-auto max-w-7xl px-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-white/25">
          ...
          <div className="flex gap-6">
            ...
            <Link href="/report"    className="hover:text-white/60 transition-colors">Report Incident</Link>
          </div>
        </div>
      </footer>
    </div>
